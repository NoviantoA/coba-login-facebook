...
const UpdateUser = ({userId, setResponseUser}) => {
    ...
    const updateUser = async(e) => {
        ...
        if(!response.ok){
            throw new Error("Uppsss... Terjadi Kesalahan")
        }
        // tampung hasil response
        const _user = await response.json()
                ...
                <Transition.Child
                 ...
                 leaveTo="opacity-0 scale-95">
                    <div className='inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-md'>
                        <Dialog.Title as='h3' className='text-large font-medium leading-6 text-gray-900'>Update User</Dialog.Title>
                        ...
                        <div className='py-2'>
                            ...
                            <div className='h-14 my-4'>
                                ...
                                <input type='text' name='email' value={user.email}  onChange={(e) => handleChange(e)} className='h-10 w-96 border mt-2 px-2 py-2'></input>
                            </div>
